...
\begin{figure}[H] %We begin our figure and want it to stay H(ere)
	\centering %We want to center the figure
\includegraphics [scale= .85]  {TrumpWordCloudAlteryxFinal.PNG}    %Include our ijmage with a height and location of img.
	\caption[Optional caption] {real, local caption for refrence}
	\label{fig:wordcloudBliz}
...
\section{Modelling}
The models I have created with Tableau (Frontend), which conclusions can we draw from them etc.
